...
alias whrc-portal-mysqldump='whrc-portal-docker-compose exec -e MYSQL_PWD=password php mysqldump -h mysql -uwhrc-portal whrc-portal'
alias whrc-portal-test-mysql='whrc-portal-docker-compose exec -e MYSQL_PWD=password php_testing mysql -h mysql_testing -uwhrc-portal whrc-portal'
alias whrc-portal-test-mysqldump='whrc-portal-docker-compose exec -e MYSQL_PWD=password php_testing mysqldump -h mysql_testing -uwhrc-portal whrc-portal'
