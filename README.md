...
_My personal dotfiles. Originally inspired by [Freek Van der Herten's dotfiles](https://github.com/freekmurze/dotfiles) and later by [Dries](https://github.com/driesvints/dotfiles)._
